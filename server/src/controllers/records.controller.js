...
const list = asyncHandler(async (req, res) => {
  const { equipment, equipmentIds, equipmentLines, symptomTexts, workTeams, dateFrom, dateTo, year, month, maintenanceType, companySource, needsTypeReview, page, limit } = req.query;
